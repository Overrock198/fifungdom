const calendarData = {
  ...
  //   series    – seriematch (team: 1 or 2, home: true/false, opponent: string)
  ...
  //   time: "18:00"   – bekräftad starttid (visas i tidskolumn)
  //   holiday: true   – gör datumsiffran röd (t.ex. match på nationaldagen)
  //   bollkallar: ""  – lag som är bollkallar (visas på A-lagsmatcher)
  //   note: "..."     – fri kommentar (visas ej än)
  ...
  events: [
    ...
    { date: "2026-04-13", type: "training", time: "17:30-18:45" },
    ...
    { date: "2026-04-20", type: "training", time: "17:30-18:45" },
    { date: "2026-04-21", type: "match-a",  opponent: "Konga SK",            time: "18:45", bollkallar: null },
    { date: "2026-04-23", type: "training", time: "17:30-18:45" },
    { date: "2026-04-25", type: "series",   team: 1, home: false, opponent: "Östers IF 2",         time: "10:00" },
    { date: "2026-04-26", type: "series",   team: 2, home: true,  opponent: "Hovshaga AIF 8",      time: "10:00" },
    ...
    { date: "2026-05-02", type: "series",   team: 2, home: false, opponent: "Växjö BK 7",          time: "10:00" },
    { date: "2026-05-03", type: "series",   team: 1, home: true,  opponent: "Alvesta GOIF 1",      time: "10:00" },
    ...
    { date: "2026-05-09", type: "series",   team: 1, home: false, opponent: "Växjö Norra IF 2",    time: "10:00" },
    { date: "2026-05-10", type: "series",   team: 2, home: true,  opponent: "Älmhults IF 4",       time: "10:00" },
    ...
    { date: "2026-05-31", type: "series",   team: 1, home: true,  opponent: "Värnamo Södra FF 2" },
    ...
    { date: "2026-06-06", type: "series",   team: 2, home: true,  opponent: "Ingelstads IK 3",     time: "14:00", holiday: true },
    { date: "2026-06-07", type: "series",   team: 1, home: false, opponent: "Hovshaga AIF 5",      time: "12:00" },
    ...
    { date: "2026-06-14", type: "series",   team: 1, home: true,  opponent: "IFK Grimslöv 1" },
